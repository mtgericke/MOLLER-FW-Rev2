...
################################################################
# This is a generated script based on design: Mercury_XU1
#
...
proc create_root_design { parentCell } {
  ...
  set TI_C2H [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 TI_C2H ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
   ] $TI_C2H

  set adc_fifo [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 adc_fifo ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
  ...
  set run_fifo [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:axis_rtl:1.0 run_fifo ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {125000000} \
   CONFIG.HAS_TKEEP {0} \
   CONFIG.HAS_TLAST {1} \
  ...
  # Create ports
  set CLK250 [ create_bd_port -dir I CLK250 ]
  set CLK625 [ create_bd_port -dir I CLK625 ]
  ...
  set TI1RX_P [ create_bd_port -dir I TI1RX_P ]
  set TI1SYNCRX_N [ create_bd_port -dir I TI1SYNCRX_N ]
  set TI1SYNCRX_P [ create_bd_port -dir I TI1SYNCRX_P ]
  set TI1SYNCTX_N [ create_bd_port -dir O TI1SYNCTX_N ]
  set TI1SYNCTX_P [ create_bd_port -dir O TI1SYNCTX_P ]
  set TI1TX_N [ create_bd_port -dir O TI1TX_N ]
  set TI1TX_P [ create_bd_port -dir O TI1TX_P ]
  ...
  set adc_test_data_bad_pattern_counter [ create_bd_port -dir I -from 255 -to 0 adc_test_data_bad_pattern_counter ]
  set clk_125 [ create_bd_port -dir I -type clk -freq_hz 125000000 clk_125 ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {run_fifo:adc_fifo:TI_C2H} \
   CONFIG.ASSOCIATED_RESET {rst_125_n:soc_in_reset:SYNC_RESET_0} \
 ] $clk_125
  set freq_osc_value [ create_bd_port -dir I -from 31 -to 0 freq_osc_value ]
  ...
  set status_clk_lockdetect [ create_bd_port -dir I -from 0 -to 0 status_clk_lockdetect ]
  set stream_ctrl_ch0 [ create_bd_port -dir O -from 3 -to 0 stream_ctrl_ch0 ]
  set stream_ctrl_ch1 [ create_bd_port -dir O -from 3 -to 0 stream_ctrl_ch1 ]
  ...
  set packet_switch [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_switch:1.1 packet_switch ]
  set_property -dict [ list \
  ...
  # Create instance: phy_id, and set properties
  set phy_id [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 phy_id ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {9} \
   CONFIG.CONST_WIDTH {5} \
 ] $phy_id
  ...
  # Create instance: run_fifo, and set properties
  set run_fifo [ create_bd_cell -type ip -vlnv xilinx.com:ip:axis_data_fifo:2.0 run_fifo ]
  set_property -dict [ list \
  ...
  # Create instance: ti_zero, and set properties
  set ti_zero [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 ti_zero ]
  set_property -dict [ list \
   CONFIG.CONST_VAL {0} \
 ] $ti_zero
  ...
  set_property -dict [ list \
   ...
   CONFIG.PSU__PROTECTION__MASTERS {USB1:NonSecure;0|USB0:NonSecure;1|S_AXI_LPD:NA;0|S_AXI_HPC1_FPD:NA;0|S_AXI_HPC0_FPD:NA;1|S_AXI_HP3_FPD:NA;0|S_AXI_HP2_FPD:NA;0|S_AXI_HP1_FPD:NA;0|S_AXI_HP0_FPD:NA;0|S_AXI_ACP:NA;0|S_AXI_ACE:NA;0|SD1:NonSecure;1|SD0:NonSecure;1|SATA1:NonSecure;0|SATA0:NonSecure;0|RPU1:Secure;1|RPU0:Secure;1|QSPI:NonSecure;1|PMU:NA;1|PCIe:NonSecure;0|NAND:NonSecure;0|LDMA:NonSecure;1|GPU:NonSecure;1|GEM3:NonSecure;1|GEM2:NonSecure;1|GEM1:NonSecure;0|GEM0:NonSecure;1|FDMA:NonSecure;1|DP:NonSecure;0|DAP:NA;1|Coresight:NA;1|CSU:NA;1|APU:NA;1} \
  ...
  connect_bd_intf_net -intf_net S_AXIS_0_1 [get_bd_intf_ports run_fifo] [get_bd_intf_pins run_fifo/S_AXIS]
  connect_bd_intf_net -intf_net S_AXIS_1_1 [get_bd_intf_ports adc_fifo] [get_bd_intf_pins adc_fifo/S_AXIS]
  ...
  connect_bd_intf_net -intf_net mollerTI_0_C2H [get_bd_intf_ports TI_C2H] [get_bd_intf_pins mollerTI_0/C2H]
  ...
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_GMII_ENET1 [get_bd_intf_pins gig_ethernet_pcs_pma_0/gmii_gem_pcs_pma] [get_bd_intf_pins zynq_ultra_ps_e/GMII_ENET2]
  set_property HDL_ATTRIBUTE.DEBUG {true} [get_bd_intf_nets zynq_ultra_ps_e_GMII_ENET1]
  connect_bd_intf_net -intf_net zynq_ultra_ps_e_MDIO_ENET2 [get_bd_intf_pins gig_ethernet_pcs_pma_0/mdio_pcs_pma] [get_bd_intf_pins zynq_ultra_ps_e/MDIO_ENET2]
  ...
  connect_bd_net -net Net [get_bd_ports clk_125] [get_bd_pins adc_fifo/s_axis_aclk] [get_bd_pins mollerTI_0/s_axi_aclk] [get_bd_pins moller_regmap/s00_axi_aclk] [get_bd_pins run_fifo/s_axis_aclk] [get_bd_pins smartconnect_0/aclk1]
  ...
  connect_bd_net -net mollerTI_0_TCSOUT [get_bd_ports TCSOUT] [get_bd_pins mollerTI_0/TCSOUT]
  connect_bd_net -net mollerTI_0_TI1SYNCTX_N [get_bd_ports TI1SYNCTX_N] [get_bd_pins mollerTI_0/TI1SYNCTX_N]
  connect_bd_net -net mollerTI_0_TI1SYNCTX_P [get_bd_ports TI1SYNCTX_P] [get_bd_pins mollerTI_0/TI1SYNCTX_P]
  connect_bd_net -net mollerTI_0_TI1TX_N [get_bd_ports TI1TX_N] [get_bd_pins mollerTI_0/TI1TX_N]
  connect_bd_net -net mollerTI_0_TI1TX_P [get_bd_ports TI1TX_P] [get_bd_pins mollerTI_0/TI1TX_P]
  connect_bd_net -net moller_regmap_0_stream_ctrl_ch0 [get_bd_ports stream_ctrl_ch0] [get_bd_pins moller_regmap/stream_ctrl_ch0]
  connect_bd_net -net moller_regmap_0_stream_ctrl_ch1 [get_bd_ports stream_ctrl_ch1] [get_bd_pins moller_regmap/stream_ctrl_ch1]
  connect_bd_net -net moller_regmap_0_stream_ctrl_enable [get_bd_ports stream_ctrl_enable] [get_bd_pins moller_regmap/stream_ctrl_enable]
  ...
  connect_bd_net -net rst_125_1 [get_bd_ports rst_125_n] [get_bd_pins adc_fifo/s_axis_aresetn] [get_bd_pins mollerTI_0/s_axi_aresetn] [get_bd_pins moller_regmap/s00_axi_aresetn] [get_bd_pins run_fifo/s_axis_aresetn]
  ...
  connect_bd_net -net xlconstant_1_dout [get_bd_pins moller_regmap/ti_fifo_count] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net xlconstant_4_dout [get_bd_pins mollerTI_0/h2c_tvalid] [get_bd_pins ti_zero/dout]
  connect_bd_net -net xlconstant_6_dout [get_bd_pins gig_ethernet_pcs_pma_0/phyaddr] [get_bd_pins phy_id/dout]
  connect_bd_net -net xlconstant_7_dout [get_bd_pins gig_ethernet_pcs_pma_0/configuration_vector] [get_bd_pins phy_cfg/dout]
  connect_bd_net -net xlconstant_8_dout [get_bd_pins gig_ethernet_pcs_pma_0/an_adv_config_val] [get_bd_pins gig_ethernet_pcs_pma_0/an_restart_config] [get_bd_pins gig_ethernet_pcs_pma_0/configuration_valid] [get_bd_pins zero/dout]
  connect_bd_net -net xlconstant_9_dout [get_bd_pins an_adv_cfg/dout] [get_bd_pins gig_ethernet_pcs_pma_0/an_adv_config_vector]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP0/HPC0_DDR_LOW] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP0/HPC0_QSPI] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP0/HPC0_QSPI] -force
  assign_bd_address -offset 0xA0000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x80010000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs mollerTI_0/S_AXI/S_AXI_reg] -force
  assign_bd_address -offset 0x80000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces zynq_ultra_ps_e/Data] [get_bd_addr_segs moller_regmap/S00_AXI/S00_AXI_reg] -force

  # Exclude Address Segments
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP0/HPC0_LPS_OCM]
  exclude_bd_addr_seg -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_SG] [get_bd_addr_segs zynq_ultra_ps_e/SAXIGP0/HPC0_LPS_OCM]
